...
.login-card {
    ...
    width: 400px; 
    max-width:95%;
    box-shadow: 0 0 25px rgba(255,187,0,0.7);
...
.input-group input:focus { 
    border-color:#ffcc33; 
    box-shadow: 0 0 12px #ffbb00, 0 0 25px #ffcc33; 
    outline:none; 
}
.input-group i { 
...
.login-card a:hover { color:#ffaa00; }
</style>
...
<div class="login-card">
    <h1>Đăng Nhập</h1>
    <p>Đăng nhập để mua sắm phụ kiện máy tính gaming & PC cao cấp</p>
    ...
    <form method="post" action="/auth/login">
        ...
        <div class="input-group">
            <input type="text" name="email" placeholder="Email hoặc username" value="{{ old('email') }}">
    ...
    <p style="margin-top:15px;"><a href="/auth/register">Chưa có tài khoản? Đăng ký ngay!</a></p>
</div>
@endsection
